...
class Footer extends Component {
  render() {
    return (
      <>
        <div className="container-fluid bg-primary mt-4">
          <div className="container">
            <div className="container">
              <div className="row">
                <div className="col-lg-3 text-white d-block">
                  <span className="fs-4 d-block">
                    <b>Keperluan Rumah</b>
                  </span>
                  <span className="d-block">A second item</span>
                  <span className="d-block">A second item</span>
                  <span className="d-block">A second item</span>
                  <span className="d-block">A second item</span>
                </div>
                ...
                <div className="col-lg-3 text-white">
                  ...
                  <span className="d-block">Berlangganan Sekarang</span>
